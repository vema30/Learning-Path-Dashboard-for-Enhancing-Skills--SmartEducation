...
const createCourse = async (req, res) => {
  try {
    ...
    console.log("Files in createCourse", req.files);
    ...
    try {
      ...
      console.log("Error in uploading image to Cloudinary:", e.message);
    ...
    console.log("Category updated with new course", categoryDetails2);
